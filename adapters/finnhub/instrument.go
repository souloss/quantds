...
func NewInstrumentAdapter(client *finnhub.Client) *InstrumentAdapter {
...
func (a *InstrumentAdapter) Fetch(ctx context.Context, _ request.Client, req instrument.Request) (instrument.Response, *manager.RequestTrace, error) {
	...
	result, record, err := a.client.GetStockSymbols(ctx, &finnhub.SymbolParams{Exchange: "US"})
